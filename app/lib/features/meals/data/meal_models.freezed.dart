...
mixin _$MealAnalysisItem {
 ...
 int? get foodItemId; num get quantityG; num get kcal; num get proteinG; num get carbsG; num get fatG;
...
@override
String toString() {
  return 'MealAnalysisItem(description: $description, foodItemId: $foodItemId, quantityG: $quantityG, kcal: $kcal, proteinG: $proteinG, carbsG: $carbsG, fatG: $fatG)';
}
...
class _MealAnalysisItem implements MealAnalysisItem {
  const _MealAnalysisItem({required this.description, this.foodItemId, this.quantityG = 0, this.kcal = 0, this.proteinG = 0, this.carbsG = 0, this.fatG = 0});
...
/// resultado da análise sobrevive à imagem.
 String? get photoUrl; String? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,analysisJobId,const DeepCollectionEquality().hash(items),totalKcal,totalProteinG,totalCarbsG,totalFatG,userAdjusted,excludedFromDiary,photoUrl,createdAt);

@override
String toString() {
  return 'MealAnalysis(id: $id, analysisJobId: $analysisJobId, items: $items, totalKcal: $totalKcal, totalProteinG: $totalProteinG, totalCarbsG: $totalCarbsG, totalFatG: $totalFatG, userAdjusted: $userAdjusted, excludedFromDiary: $excludedFromDiary, photoUrl: $photoUrl, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String? analysisJobId, List<MealAnalysisItem> items, num totalKcal, num totalProteinG, num totalCarbsG, num totalFatG, bool userAdjusted, bool excludedFromDiary, String? photoUrl, String? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? analysisJobId,  List<MealAnalysisItem> items,  num totalKcal,  num totalProteinG,  num totalCarbsG,  num totalFatG,  bool userAdjusted,  bool excludedFromDiary,  String? photoUrl,  String? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MealAnalysis() when $default != null:
return $default(_that.id,_that.analysisJobId,_that.items,_that.totalKcal,_that.totalProteinG,_that.totalCarbsG,_that.totalFatG,_that.userAdjusted,_that.excludedFromDiary,_that.photoUrl,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? analysisJobId,  List<MealAnalysisItem> items,  num totalKcal,  num totalProteinG,  num totalCarbsG,  num totalFatG,  bool userAdjusted,  bool excludedFromDiary,  String? photoUrl,  String? createdAt)  $default,) {final _that = this;
switch (_that) {
case _MealAnalysis():
return $default(_that.id,_that.analysisJobId,_that.items,_that.totalKcal,_that.totalProteinG,_that.totalCarbsG,_that.totalFatG,_that.userAdjusted,_that.excludedFromDiary,_that.photoUrl,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? analysisJobId,  List<MealAnalysisItem> items,  num totalKcal,  num totalProteinG,  num totalCarbsG,  num totalFatG,  bool userAdjusted,  bool excludedFromDiary,  String? photoUrl,  String? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _MealAnalysis() when $default != null:
return $default(_that.id,_that.analysisJobId,_that.items,_that.totalKcal,_that.totalProteinG,_that.totalCarbsG,_that.totalFatG,_that.userAdjusted,_that.excludedFromDiary,_that.photoUrl,_that.createdAt);case _:
  return null;
...
class _MealAnalysis implements MealAnalysis {
  const _MealAnalysis({required this.id, this.analysisJobId, final  List<MealAnalysisItem> items = const [], this.totalKcal = 0, this.totalProteinG = 0, this.totalCarbsG = 0, this.totalFatG = 0, this.userAdjusted = false, this.excludedFromDiary = false, this.photoUrl, this.createdAt}): _items = items;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,analysisJobId,const DeepCollectionEquality().hash(_items),totalKcal,totalProteinG,totalCarbsG,totalFatG,userAdjusted,excludedFromDiary,photoUrl,createdAt);
